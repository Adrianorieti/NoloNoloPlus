...
exports.default = (function (state, action) {
    switch (action.type) {
        ...
        case actionTypes.SET_SELECTED_DATE:
            return __assign({}, state, { year: date_fns_1.getYear(action.payload), month: date_fns_1.getMonth(action.payload), selectedDate: action.payload, focussedDate: action.payload, showCalendar: false });
        case actionTypes.SET_FOCUSSED_DATE:
            return __assign({}, state, { year: date_fns_1.getYear(action.payload), month: date_fns_1.getMonth(action.payload), focussedDate: action.payload });
        ...
        case actionTypes.HIDE_CALENDAR:
            return __assign({}, state, { year: date_fns_1.getYear(state.selectedDate), month: date_fns_1.getMonth(state.selectedDate), focussedDate: state.selectedDate, showCalendar: false });
        default:
            return state;
    }
});
